...
... and **[ClassMaps](https://joshclose.github.io/CsvHelper/examples/configuration/class-maps/)** which allow the mapping definition to be kept separate from your domain model or DTO.
